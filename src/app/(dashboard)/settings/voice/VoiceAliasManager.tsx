...
import { createVoiceAliasAction, setVoiceAliasActiveAction } from "./actions";
...
export function VoiceAliasManager({ aliases, voiceEnabled, loadError, memberEmails }: Props) {
