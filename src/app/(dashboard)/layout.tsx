...
export default async function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="storeos-app" style={themeStyle}>
      ...
      <PushTokenRegistrar />
      {/* ผู้ช่วยหลังร้าน — เฉพาะเจ้าของ/ผู้จัดการ และเฉพาะแพ็กเกจที่มีผู้ช่วย AI
          (ฝั่ง server ยังกั้นซ้ำที่ tool ทุกตัว ปุ่มที่หลุดมาก็สั่งอะไรไม่ได้) */}
      {can(BACK_OFFICE_ASSISTANT_PERMISSION) && assistantEnabled ? <BackOfficeAssistant /> : null}
