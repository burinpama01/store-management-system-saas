...
============================================================
  รู้ว่าติดตั้ง "สำเร็จ" อย่างไร (สำคัญ)
============================================================
- ตัวติดตั้งจะตรวจว่า task กำลังทำงาน (Running) ให้เอง
- แต่สัญญาณสำเร็จสุดท้ายคือ กลับไปที่หน้า StoreOS > ตั้งค่า > Print Hub
  แล้วรอสถานะเปลี่ยนเป็น "Hub ออนไลน์" (heartbeat ฝั่งคลาวด์ทุก ~2.5 วินาที)
- ถ้าสถานะยังออฟไลน์เกิน 1 นาที: กด "ตรวจใหม่" หรือเปิด Task Scheduler
  ดู task "StoreOSPrintHub" ว่า Running หรือไม่
- ไฟล์ print-hub.config.json มี token ลับของร้าน ระบบตั้งสิทธิ์ไว้ให้
  อ่านได้เฉพาะผู้ใช้ที่ติดตั้ง (icacls) อย่าส่งไฟล์นี้ให้คนอื่น