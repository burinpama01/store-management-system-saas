...
import { runPollCycle, isAllowedNetworkPrinterHost, decodePrintJobBase64 } from "../../scripts/print-hub.mjs";
...
describe("print hub agent — runPollCycle", () => {
  it("prints each claimed job and acks success", async () => {
    ...
    expect(printJob).toHaveBeenCalledWith("192.168.1.50", 9100, expect.any(Buffer));
