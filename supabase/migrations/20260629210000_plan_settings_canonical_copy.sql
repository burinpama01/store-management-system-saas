...
update plan_settings set feature_lines =
  '["ไม่จำกัดสาขา/สมาชิก","ทุกอย่างในแพ็กเกจ Premium","จอแสดงผลลูกค้า","สมาชิก QR + สะสมแต้ม + คูปอง","ขอเพลง + เครื่องเล่นเพลงอัตโนมัติ","รายงานหลายสาขา","เชื่อมต่อ API","ผู้ช่วย AI ตอบคำถามและช่วยตั้งค่า","ซัพพอร์ตพิเศษ"]'::jsonb,
  updated_at = now()
